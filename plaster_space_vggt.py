...
from calibration import calibrate_camera_from_primer, calibrate_camera_vggt_from_primer
import traceback
import sys
import pycolmap
...
vg_group.add_argument("--min_inlier_per_frame", type=int, default=20, help="Minimum inliers per frame to consider it valid")
    ...
    for day in source_plaster["days"]:
        ...
        for ms in day_plaster["multisequences"]:
            ...
            try:
                ...
                calib_res = calibrate_camera_vggt_from_primer(
                    frames=frame_data,
